...
for subject_id in subject_ids:
    ...
    out_path = op.join(base_dir, 'derivatives', pipeline, subject_id,'05_zapped_data')
    [data, iterations]=zapline_until_gone(epochs.get_data(), 60, epochs.info['sfreq'], viz=True,
                                          prefix=op.join(base_dir, 'derivatives', pipeline, subject_id,"zapline_iter"))
